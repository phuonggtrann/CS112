...
class AllTests (unittest.TestCase):
	...
	def test_checkout_01 (self): self.assertEqual(checkout(0, 0, 0),    0)
	def test_checkout_02 (self): self.assertEqual(checkout(0, 0, 1),  203)
	def test_checkout_03 (self): self.assertEqual(checkout(0, 1, 0),  374)
	def test_checkout_04 (self): self.assertEqual(checkout(1, 0, 0),  986)
	def test_checkout_05 (self): self.assertEqual(checkout(0, 2, 3), 1357)
	def test_checkout_06 (self): self.assertEqual(checkout(1, 0, 1), 1189)
	def test_checkout_07 (self): self.assertEqual(checkout(7, 0, 0), 6902)
	def test_checkout_08 (self): self.assertEqual(checkout(5, 5, 5), 7815)
	def test_checkout_09 (self): self.assertEqual(checkout(4, 2, 0), 4692)
	def test_checkout_10 (self): self.assertEqual(checkout(3, 2, 1), 3909)
	def test_checkout_11 (self): self.assertEqual(checkout(0, 2, 0),  748)
	def test_checkout_12 (self): self.assertEqual(checkout(8, 4, 0), 9384)
	def test_checkout_13 (self): self.assertEqual(checkout(1, 1, 1), 1563)
	def test_checkout_14 (self): self.assertEqual(checkout(2, 2, 2), 3126)
	def test_checkout_15 (self): self.assertEqual(checkout(0, 0,10), 2030)
	
	# timing
	def test_timing_01 (self): self.assertEqual(timing(    5),(0, 0, 0, 5))
	def test_timing_02 (self): self.assertEqual(timing(   60),(0, 0, 1, 0))
	def test_timing_03 (self): self.assertEqual(timing(   61),(0, 0, 1, 1))
	def test_timing_04 (self): self.assertEqual(timing(  200),(0, 0, 3,20))
	def test_timing_05 (self): self.assertEqual(timing( 1439),(0, 0,23,59))
	def test_timing_06 (self): self.assertEqual(timing( 1440),(0, 1, 0, 0))
	def test_timing_07 (self): self.assertEqual(timing( 1499),(0, 1, 0,59))
	...
	# extra credit: catch_bus

	def test_extra_credit_catch_bus_1 (self): self.assertEqual(catch_bus( 100, 30,1), 4)
	def test_extra_credit_catch_bus_2 (self): self.assertEqual(catch_bus( 100, 20,1), 5)
	def test_extra_credit_catch_bus_3 (self): self.assertEqual(catch_bus( 100, 20,2), 6)
	def test_extra_credit_catch_bus_4 (self): self.assertEqual(catch_bus(1000,200,3), 6)
	def test_extra_credit_catch_bus_5 (self): self.assertEqual(catch_bus(1000,200,4), 8)
