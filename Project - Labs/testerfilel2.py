...
class AllTests (unittest.TestCase):
	...
	def test_add3_1(self): self.assertEqual(add3(1,2,3),6)
	def test_add3_2(self): self.assertEqual(add3(100,100,100),300)
	
	def test_inch_height_1(self): self.assertEqual(inch_height(0,5),5)
	def test_inch_height_2(self): self.assertEqual(inch_height(5,10),70)
	def test_inch_height_3(self): self.assertEqual(inch_height(8,11),107)
	def test_inch_height_4(self): self.assertEqual(inch_height(4,0),48)
	def test_inch_height_5(self): self.assertEqual(inch_height(6,0),72)
	def test_inch_height_6(self): self.assertEqual(inch_height(6,1),73)
	def test_inch_height_7(self): self.assertEqual(inch_height(6,2),74)
	def test_inch_height_8(self): self.assertEqual(inch_height(100,0),1200)
	def test_inch_height_9(self): self.assertEqual(inch_height(11,11),143)
	
	def test_gas_cost_1(self): self.assertEqual(gas_cost(1.0,5.0),5.0)
	def test_gas_cost_2(self): self.assertEqual(gas_cost(5.0,1.0),5.0)
	def test_gas_cost_3(self): self.assertEqual(gas_cost(2.5,3.0),7.5)
	def test_gas_cost_4(self): self.assertEqual(gas_cost(3.0,12.0),36.0)
	def test_gas_cost_5(self): self.assertEqual(gas_cost(2.99,15.0),44.85)
	def test_gas_cost_6(self): self.assertEqual(gas_cost(0.9,10.0),9.0)
	def test_gas_cost_7(self): self.assertEqual(gas_cost(0.8,15.5),12.4)
	def test_gas_cost_8(self): self.assertEqual(gas_cost(12.0,34.5),414.0)
	def test_gas_cost_9(self): self.assertEqual(gas_cost(10.0,100.0),1000.0)
