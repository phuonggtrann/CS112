...
REQUIRED_DEFNS = [ "location","fibonacci","int_sqrt","sum_evens_2d"	]
...
# assuming student's code does print a ranking number and a timing number for 
# each of our three runners, this will extract those six numbers for us.
# students don't have to know how this function works.
def extract_numbers(msg):
	lines = msg.split("\n")
	r1 = lines[-3].split(".")[0]
	r2 = lines[-2].split(".")[0]
	r3 = lines[-1].split(".")[0]
	t1 = lines[-3].split("(")[1].split()[0]
	t2 = lines[-2].split("(")[1].split()[0]
	t3 = lines[-1].split("(")[1].split()[0]
	
	# the three rankings, then the three timings
...
class AllTests (unittest.TestCase):
	...
	def test_location_1 (self): self.assertEqual (location([5,10,15,20,25],15),2)
	def test_location_2 (self): self.assertEqual (location([3,4,5,6,4,4,4,4,4],4),1)
	def test_location_3 (self): self.assertEqual (location([100, 105, 110],234),None)
	def test_location_4 (self): self.assertEqual (location([5,10,15,20,25],5),0)
	def test_location_5 (self): self.assertEqual (location([5,10,15,20,25],25),4)
	def test_location_6 (self): self.assertEqual (location([],5),None)
	def test_location_7 (self): self.assertEqual (location([2,3],3),1)
	def test_location_8 (self): self.assertEqual (location([3],3),0)
	def test_location_9 (self): self.assertEqual (location(["where","is","waldo","?"],"waldo"),2)
	def test_location_10(self): self.assertEqual (location([1,2,3,[2,3],4,5],[2,3]),3)
	
	def test_fibonacci_1 (self): self.assertEqual (fibonacci(0),1)
	def test_fibonacci_2 (self): self.assertEqual (fibonacci(1),1)
	def test_fibonacci_3 (self): self.assertEqual (fibonacci(2),2)
	def test_fibonacci_4 (self): self.assertEqual (fibonacci(3),3)
	def test_fibonacci_5 (self): self.assertEqual (fibonacci(4),5)
	def test_fibonacci_6 (self): self.assertEqual (fibonacci(5),8)
	def test_fibonacci_7 (self): self.assertEqual (fibonacci(7),21)
	def test_fibonacci_8 (self): self.assertEqual (fibonacci(15),987)
	def test_fibonacci_9 (self): self.assertEqual (fibonacci(100),573147844013817084101)
	def test_fibonacci_10(self): self.assertEqual (fibonacci(1000),70330367711422815821835254877183549770181269836358732742604905087154537118196933579742249494562611733487750449241765991088186363265450223647106012053374121273867339111198139373125598767690091902245245323403501)
	
	def test_int_sqrt_1  (self): self.assertEqual (int_sqrt(1),1)
	def test_int_sqrt_2  (self): self.assertEqual (int_sqrt(4),2)
	def test_int_sqrt_3  (self): self.assertEqual (int_sqrt(5),2)
	def test_int_sqrt_4  (self): self.assertEqual (int_sqrt(6),2)
	def test_int_sqrt_5  (self): self.assertEqual (int_sqrt(7),2)
	def test_int_sqrt_6  (self): self.assertEqual (int_sqrt(8),2)
	def test_int_sqrt_7  (self): self.assertEqual (int_sqrt(9),3)
	def test_int_sqrt_8  (self): self.assertEqual (int_sqrt(10000),100)
	def test_int_sqrt_9  (self): self.assertEqual (int_sqrt(123456789),11111)
	def test_int_sqrt_10 (self): self.assertEqual (int_sqrt(42),6)
