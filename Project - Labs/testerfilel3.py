...
class AllTests (unittest.TestCase):
	...
	def test_is_even_1(self): self.assertEqual(is_even(0),True)
	def test_is_even_2(self): self.assertEqual(is_even(1),False)
	def test_is_even_3(self): self.assertEqual(is_even(2),True)
	def test_is_even_4(self): self.assertEqual(is_even(3),False)
	def test_is_even_5(self): self.assertEqual(is_even(4),True)
	def test_is_even_6(self): self.assertEqual(is_even(5),False)
	def test_is_even_7(self): self.assertEqual(is_even(10),True)
	def test_is_even_8(self): self.assertEqual(is_even(12342),True)
    	
	def test_letter_grade_1(self): self.assertEqual(letter_grade(105),"A+")
	def test_letter_grade_2(self): self.assertEqual(letter_grade(98),"A+")
	def test_letter_grade_3(self): self.assertEqual(letter_grade(97),"A")
	def test_letter_grade_4(self): self.assertEqual(letter_grade(92),"A")
	def test_letter_grade_5(self): self.assertEqual(letter_grade(91),"A-")
	def test_letter_grade_6(self): self.assertEqual(letter_grade(90),"A-")
	def test_letter_grade_7(self): self.assertEqual(letter_grade(89),"B+")
	def test_letter_grade_8(self): self.assertEqual(letter_grade(88),"B+")
	def test_letter_grade_9(self): self.assertEqual(letter_grade(87),"B")
	def test_letter_grade_10(self): self.assertEqual(letter_grade(82),"B")
	def test_letter_grade_11(self): self.assertEqual(letter_grade(81),"B-")
	def test_letter_grade_12(self): self.assertEqual(letter_grade(80),"B-")
	def test_letter_grade_13(self): self.assertEqual(letter_grade(79),"C+")
	def test_letter_grade_14(self): self.assertEqual(letter_grade(78),"C+")
	def test_letter_grade_15(self): self.assertEqual(letter_grade(76),"C")
	def test_letter_grade_16(self): self.assertEqual(letter_grade(72),"C")
	def test_letter_grade_17(self): self.assertEqual(letter_grade(71),"C-")
	def test_letter_grade_18(self): self.assertEqual(letter_grade(70),"C-")
	def test_letter_grade_19(self): self.assertEqual(letter_grade(69),"D")
	def test_letter_grade_20(self): self.assertEqual(letter_grade(60),"D")
	def test_letter_grade_21(self): self.assertEqual(letter_grade(59),"F")
	def test_letter_grade_22(self): self.assertEqual(letter_grade(0),"F")
 	
	def test_sum2biggest_1(self): self.assertEqual(sum2biggest(5,3,4),9)
	def test_sum2biggest_2(self): self.assertEqual(sum2biggest(-5,-3,-1),-4)
	def test_sum2biggest_3(self): self.assertEqual(sum2biggest(6,4,6),12)
	def test_sum2biggest_4(self): self.assertEqual(sum2biggest(0,0,0),0)
	def test_sum2biggest_5(self): self.assertEqual(sum2biggest(2,3,4),7)
	def test_sum2biggest_6(self): self.assertEqual(sum2biggest(2,4,3),7)
	def test_sum2biggest_7(self): self.assertEqual(sum2biggest(3,2,4),7)
	def test_sum2biggest_8(self): self.assertEqual(sum2biggest(3,4,2),7)
	def test_sum2biggest_9(self): self.assertEqual(sum2biggest(4,2,3),7)
	def test_sum2biggest_10(self): self.assertEqual(sum2biggest(4,3,2),7)
	def test_sum2biggest_11(self): self.assertEqual(sum2biggest(3,3,7),10)
	def test_sum2biggest_12(self): self.assertEqual(sum2biggest(3,7,3),10)
	def test_sum2biggest_13(self): self.assertEqual(sum2biggest(7,3,3),10)
	def test_sum2biggest_14(self): self.assertEqual(sum2biggest(5,8,8),16)
	def test_sum2biggest_15(self): self.assertEqual(sum2biggest(8,5,8),16)
	def test_sum2biggest_16(self): self.assertEqual(sum2biggest(8,8,5),16)
	def test_sum2biggest_17(self): self.assertEqual(sum2biggest(-5,-5,-3),-8)
	def test_sum2biggest_18(self): self.assertEqual(sum2biggest(-6,-4,-4),-8)
	def test_sum2biggest_19(self): self.assertEqual(sum2biggest(-5,0,3),3)
	def test_sum2biggest_20(self): self.assertEqual(sum2biggest(-10,-5,5),0)
