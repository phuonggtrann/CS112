...
REQUIRED_DEFNS = [ "recursive_len", "lucas", "remove_duplicates", "binary" ]
...
# these functions exploit the weakness of recursion: 
# we might eventually run out of stack space if we have
# too many recursive calls. These blocks expect that to
# happen, and recover/continue if that happens, but calls fail()
# if we've not used a recursive solution.

def force_recursive_len(self):
	try:
		recursive_len(list(range(2000)))
		self.fail("you need to use recursion.")
	except RuntimeError:
		pass

def force_recursive_lucas(self):
	try:
		lucas(9001)
		self.fail("you need to use recursion.")
	except RuntimeError:
...
def force_recursive_remove_duplicates(self):
	try:
		remove_duplicates("1234567890"*101)
		self.fail("you need to use recursion.")
	except RuntimeError:
		pass

def force_recursive_binary(self):
	try:
		binary(int("1"*500))
		self.fail("you need to use recursion.")
	except RuntimeError:
...
class AllTests (unittest.TestCase):
	...
	def test_recursive_len_1(self): force_recursive_len(self); self.assertEqual(recursive_len([]),0)
	def test_recursive_len_2(self): force_recursive_len(self); self.assertEqual(recursive_len([5]),1)
	def test_recursive_len_3(self): force_recursive_len(self); self.assertEqual(recursive_len([1,2,3]),3)
	def test_recursive_len_4(self): force_recursive_len(self); self.assertEqual(recursive_len([9,9,9,9,9,9,9,"what"]),8)
	def test_recursive_len_5(self): force_recursive_len(self); self.assertEqual(recursive_len([[1,2,3],[4,5,6]]),2)
	def test_recursive_len_6(self): force_recursive_len(self); self.assertEqual(recursive_len(list(range(500))),500)
	
	def test_lucas_1 (self): force_recursive_lucas(self); self.assertEqual(lucas(0),2)
	def test_lucas_2 (self): force_recursive_lucas(self); self.assertEqual(lucas(1),1)
	def test_lucas_3 (self): force_recursive_lucas(self); self.assertEqual(lucas(5),11)
	def test_lucas_4 (self): force_recursive_lucas(self); self.assertEqual(lucas(12),322)
	def test_lucas_5 (self): force_recursive_lucas(self); self.assertEqual(lucas(14),843)
	def test_lucas_6 (self): force_recursive_lucas(self); self.assertEqual(lucas(15),1364)
	
	def test_remove_duplicates_1 (self): force_recursive_remove_duplicates(self); self.assertEqual(remove_duplicates("abbcccccaaabcc"),"abcabc")
	def test_remove_duplicates_2 (self): force_recursive_remove_duplicates(self); self.assertEqual(remove_duplicates("1000000 is a million"),"10 is a milion")
	def test_remove_duplicates_3 (self): force_recursive_remove_duplicates(self); self.assertEqual(remove_duplicates(""),"")
	def test_remove_duplicates_4 (self): force_recursive_remove_duplicates(self); self.assertEqual(remove_duplicates("aabb\t\tccc\n\ndefefgg"),"ab\tc\ndefefg")
	def test_remove_duplicates_5 (self): force_recursive_remove_duplicates(self); self.assertEqual(remove_duplicates("abccba"),"abcba")
	def test_remove_duplicates_6 (self): force_recursive_remove_duplicates(self); self.assertEqual(remove_duplicates("mississippi"),"misisipi")
	
	def test_binary_1 (self): force_recursive_binary(self); self.assertEqual(binary(0),"0")
	def test_binary_2 (self): force_recursive_binary(self); self.assertEqual(binary(1),"1")
	def test_binary_3 (self): force_recursive_binary(self); self.assertEqual(binary(2),"10")
	def test_binary_4 (self): force_recursive_binary(self); self.assertEqual(binary(12),"1100")
	def test_binary_5 (self): force_recursive_binary(self); self.assertEqual(binary(2050),"100000000010")
	def test_binary_6 (self): force_recursive_binary(self); self.assertEqual(binary(127),"1111111")
	def test_binary_7 (self): force_recursive_binary(self); self.assertEqual(binary(128),"10000000")
